...
public class ShopApplication {
	...
	private final JComboBox cTypeCBox = new JComboBox();
	...
	private void initialize() {
		...
		ImsApplication.setBackground(Color.WHITE);
		
		tabbedPane.addTab("Inventory", null, ImsApplication, null);
		ImsApplication.setLayout(new FormLayout(new ColumnSpec[] {
		...
		tabbedPane.addTab("Customers", null, CmsApplication, null);
		...
		splitPane_1.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null, null));
		
		splitPane.setLeftComponent(splitPane_1);
		panel_SearchResults.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null, null));
		
		splitPane_1.setRightComponent(panel_SearchResults);
		...
		splitPane_1.setLeftComponent(panel_SearchCust);
		...
		splitPane.setRightComponent(panel_CustInfo);
		...
		gbl_panel_custInfo.columnWidths = new int[] {30, 0, 50, 70, 30};
